...
public class fStokBarang
    ...
    /**
     * Creates new form fStokBarang
     */
    public fStokBarang() {
        initComponents();
        model = new DefaultTableModel();
        tableStok.setModel(model);
        model.addColumn("Nama Barang");
        model.addColumn("Stok Out");
        model.addColumn("Stok In");
    ...
    public final void loadData() {
        ...
        String sql = "SELECT * FROM log_stok ORDER BY tanggal";
        ResultSet r = s.executeQuery
        (sql);
        while (r.next()) {
        Object[] o = new Object[5];
        o[0] = r.getString("nama_barang");
        o[1] = r.getString("stok_out");
        o[2] = r.getString("stok_in");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fStokBarang.class.getName()).
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new fStokBarang().setVisible(true);
            }
        });
    }
